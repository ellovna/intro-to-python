...
# string_1 = input("Enter a random text: ")
# char_1 = input("Enter any character: ")
# result_1 = 0
# i = 0
...
# number_1 = input("Please, enter a random number: ")
# result_2 = 1
# i = 0
...
# number_2 = input("Please, enter a random number: ")
# result_3 = ""
# i = len(number_2) - 1
# while i >= 0:
#     result_3 += number_2[i]
