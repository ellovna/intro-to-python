...
#if 10 <= number_2 <= 20:
#    result_4 = input("Thank you")
#else:
#    result_4 = input("Incorrect answer")
#print(result_4)
...
#if age >= 18:
#    result_5 = input("You can vote")
#elif age == 17:
#    result_5 = input("You can learn to drive")
#elif age == 16:
#    result_5 = input("You can buy a lottery ticket")
#else:
#    result_5 = input("You can go Trick-or-Treating")
#print(result_5)
